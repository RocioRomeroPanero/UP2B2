...
angular.module('administration.module').controller('administrationController', function($scope, APIClient, $ionicPopup, sessionService) {

    $scope.addUser = function() {
        console.log('hey');

        // pop-up con el cuestionario para el nuevo usuario: fullName, pass, email
        // score, degree, admin, dni
        $scope.data = {};
        $ionicPopup.show({
            title: 'New user',
            subTitle: 'Please complete this form ',
            template: 'Email: <input type="text" ng-model="data.email"></input>' 
            + 'Full name: <input type="text" ng-model="data.fullName"></input>' 
